				...
				<div className="grid grid-cols-2 gap-4 text-sm">
					<div>
						...
						<ul className="space-y-0.5 text-muted-foreground text-xs">
							<li>
								<strong>systemd + glibc:</strong> Traditional
							</li>
							<li>
								<strong>runit + musl:</strong> Minimal
							</li>
						</ul>
					</div>
					<div>
						...
						<ul className="space-y-0.5 text-muted-foreground text-xs">
							<li>
								<strong>With:</strong> AI installer + recipe helper
							</li>
							<li>
								<strong>Without:</strong> Manual, smaller ISO
							</li>
						</ul>
					</div>
				</div>
