		...
		<DocsLayout>
			...
			<section className="mb-8">
				...
				<p className="text-muted-foreground mb-4">
					<code className="bg-muted px-1.5 py-0.5">levitate</code> is the self-sufficient package
					manager for LevitateOS. It handles the full package lifecycle without depending on apt,
					dnf, pacman, or any other package manager.
				</p>
...
levitate info firefox | grep Features`}</CodeBlock>
			...
			<section className="mb-8">
				...
				<p className="text-muted-foreground mb-2">
					...
					<code className="bg-muted px-1.5 py-0.5">/etc/levitate/config</code>:
				</p>
