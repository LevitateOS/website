		...
		<DocsLayout>
			...
			<section className="mb-8">
				...
				<ul className="list-disc list-inside space-y-1 text-muted-foreground mb-4">
					...
					<li>
						<strong>Disk:</strong> 20GB minimum
					</li>
					<li>
						<strong>Boot:</strong> UEFI recommended
					</li>
				</ul>
...
sudo dd if=LevitateOS.iso of=/dev/sdX bs=4M status=progress oflag=sync`}</CodeBlock>
				...
				<p className="text-muted-foreground mb-2">
					Use{" "}
					<a href="https://rufus.ie" className="text-primary hover:underline">
						Rufus
					</a>{" "}
					with DD image mode.
				</p>
  ...
  -boot d`}</CodeBlock>
			...
			<section className="mb-8">
				...
				<div className="bg-muted/50 p-4  space-y-3 text-sm mb-4">
					...
					<div>
						...
						<span className="ml-2">
							I found /dev/nvme0n1 (500GB). I'll create a GPT partition table with:
						</span>
					...
					<div>
						<span className="text-muted-foreground font-medium">AI:</span>
						<span className="ml-2">
							Partitioning... Formatting... Installing base system... Creating user vince with sudo
							privileges... Done!
						</span>
					</div>
				</div>
				...
				<p className="text-muted-foreground mb-2">For advanced control, use slash commands:</p>
				<div className="overflow-x-auto">
					<table className="w-full text-sm">
						<thead>
							<tr className="border-b">
			...
			<section className="mb-8">
				...
				<p className="text-muted-foreground mt-2">
					This installs the complete Sway stack: wayland, wlroots, sway, foot terminal, waybar, wofi
					launcher, and mako notifications.
				</p>
