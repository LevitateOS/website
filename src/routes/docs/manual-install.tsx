	...
	return (
		<DocsLayout>
			...
			<p className="text-muted-foreground mb-8">
				This guide is for users installing LevitateOS <strong>without</strong> the LLM assistant. If
				you have the LLM variant, see the{" "}
				<a href="/docs/install" className="text-primary hover:underline">
					Installation Guide
				</a>{" "}
				instead.
			</p>
			...
			<section className="mb-8">
				...
				<p className="text-muted-foreground mb-4">
					After booting from the ISO, you'll be dropped into a root shell. The live environment has
					all the tools you need to partition, format, and install.
				</p>
...
root@levitate-live ~ #`}</CodeBlock>
			...
			<section className="mb-8">
				...
				<p className="text-muted-foreground mb-4">List available disks and identify your target:</p>
...
# nvme0n1 1T   WD Black SN850`}</CodeBlock>
				<p className="text-muted-foreground mt-4">
					In this guide, we'll use <code className="bg-muted px-1">/dev/sda</code>. Replace with
					your actual device.
				</p>
			</section>
...
mount /dev/sda1 /mnt/boot/efi`}</CodeBlock>
			...
			<section className="mb-8">
				...
				<p className="text-muted-foreground mb-4">Extract the base system to the target:</p>
